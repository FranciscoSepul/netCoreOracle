...
namespace BackSecurity.Dto.Company
{
    ...
    public class CompanyCreate
    {
        ...
        public string trabajadoresHombres { get; set; }
        public string trabajadoresMujeres { get; set; }
        public string costoporaccidente { get; set; }
        public string costoporcharla { get; set; }
        public string costoporvisita { get; set; }
        public string costobase { get; set; }
        public string costoporasesoria { get; set; }
        public string costoporasesoriaespecial { get; set; }
        public string costoporpersonaextra { get; set; }
        public string cantidadDeEmpleadosPorContrato { get; set; }
