...
namespace BackSecurity.Services.Services
{
    public class CompanyService : ICompanyService
    {
        ...
        public List<Dto.Company.Company> CompanyList()
        {
            try
            {
                ...
                foreach (Dto.Company.Item item in companys)
                {
                    ...
                    company.numeroTelefonico = (int)((item.numeroTelefonico != null) ? item.numeroTelefonico : 0);
        ...
        public List<Dto.PropiedadEmpresa.Item> ListPropiedadEmpresa()
        {
            return _httpService.RequestJson<Dto.PropiedadEmpresa.PropiedadEmpresaRoot>(idPropiedadEmpresa, HttpMethod.Get).items;
        }
        public List<Dto.TipoEmpresa.Item> ListTipoEmpresa()
        {
            return _httpService.RequestJson<Dto.TipoEmpresa.TipoEmpresaRoot>(idTipoDeEmpresa, HttpMethod.Get).items;
        }
        ...
        public Dto.Company.Company GetCompanyById(int id)
        {
            try
            {
                ...
                company.numeroTelefonico = (int)((item.numeroTelefonico != null) ? item.numeroTelefonico : 0);
                company.ActividadEconomica = item.ActividadEconomica;
                company.IdPropiedadEmpresa = item.IdPropiedadEmpresa.ToString();
                company.idTipoDeEmpresa = item.idTipoDeEmpresa.ToString();
                company.trabajadoresHombres = _httpService.RequestJson<EmpleadoRoot>(GetJobById, HttpMethod.Get).items.Where(x => x.idempresa == item.id_empresa && x.sexo == 1).Count();
                company.trabajadoresMujeres = _httpService.RequestJson<EmpleadoRoot>(GetJobById, HttpMethod.Get).items.Where(x => x.idempresa == item.id_empresa && x.sexo == 0).Count();
                company.CantidadDeEmpleadosPorContrato = (int)((item.CantidadDeEmpleadosPorContrato != null) ? item.CantidadDeEmpleadosPorContrato : 0);
        ...
        public bool Create(CompanyCreate company)
        {
            try
            {
                ...
                companyInsert.numeroTelefonico = int.Parse(company.numeroTelefonico);
                companyInsert.IdPropiedadEmpresa = company.idPropiedadEmpresa;
                companyInsert.idTipoDeEmpresa = company.idTipoDeEmpresa;
                companyInsert.ActividadEconomica = company.actividadEconomica;
                companyInsert.CantidadDeEmpleadosPorContrato = int.Parse(company.cantidadDeEmpleadosPorContrato);
        ...
        public BackSecurity.Dto.Factura.FacturaId GetFacturaById(int id)
        {
            try
            {
                ...
                facturaList.totalporasesoria = insertDetalleFactura.totalporasesoria;
                facturaList.totalporasesoriaespecial = insertDetalleFactura.totalporasesoriaespecial;
                facturaList.totalporaccidente = insertDetalleFactura.totalporaccidente;
                facturaList.totalporcharla = insertDetalleFactura.totalporcharla;
                facturaList.totalporpersonaextra = insertDetalleFactura.totalporpersonaextra;
               ...
               // facturaList.Rut = item.rut;
                //facturaList.DvRut = item.dvrut;
                ...
                //acturaList.trabajadoresMujeres = _httpService.RequestJson<EmpleadoRoot>(GetJobById, HttpMethod.Get).items.Where(x => x.idempresa == item.id_empresa && x.sexo == 0).Count();
                ...
                if (preciosPorE != null)
                {
                    facturaList.costoporaccidente = preciosPorE.costoporaccidente;
                    facturaList.costoporcharla = preciosPorE.costoporcharla;
                    facturaList.costoporvisita = preciosPorE.costoporvisita;
                    facturaList.costobase = preciosPorE.costobase;
                    facturaList.costoporasesoria = preciosPorE.costoporasesoria;
                    facturaList.costoporasesoriaespecial = preciosPorE.costoporasesoriaespecial;
                    facturaList.costoporpersonaextra = preciosPorE.costoporpersonaextra;
                }
                #endregion
        ...
        public Boolean UpdateDetalleFactura(int id, Factura factura, BackSecurity.Dto.PreciosPorEmpresa.Item precios)
        {
            ...
            insertDetalleFactura.totalporasesoria = (int)((factura.CostoTotal != null) ? factura.CostoTotal : 0);
            ...
            insertDetalleFactura.totalporpersonaextra = (int)((factura.CostoTotalPersonasExtra != null) ? factura.CostoTotalPersonasExtra : 0);
        ...
        public Factura GetCompanyFactura(string id, int desde)
        {
            try
            {
                ...
                if (desde==12)
                {
                    Fhasta = new DateTime(DateTime.Now.Year, 1, 01, 00, 00, 0);
                }
                else
                {
                    Fhasta = new DateTime(DateTime.Now.Year, desde + 1, 01, 00, 00, 0);
                }
